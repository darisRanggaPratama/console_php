...
$query = "SELECT * FROM sampledb ORDER BY KODE DESC";
...
<body>
	...
	<div style="width: 1000px; margin: 20px auto;">
		...
		if (isset($_GET['aksi']) == 'del') {
			...
			$query = "DELETE FROM sampledb WHERE ID=$id";
				...
				?>
					<tr>
						...
						<td style="text-align:right">
							<a href="index.php?aksi=del&id=<?php echo $nmr; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?');">
